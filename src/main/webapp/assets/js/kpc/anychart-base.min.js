...
$.g.Cd=function(){var a=fl(this);a&&$.n(this.ta)&&!this.ta&&this.u(Zk,!1);this.ta=a;if(this.nf()||this.od||!this.f||this.f.df())return this;if(!this.enabled()&&(this.N||a))return this.J(Zk)&&($.Re(this.Gd),this.I(Zk)),this;if(!ND){var b="",c=$.He("STYLE");c.type="text/css";
...
c=a?this.RI():"AnyChart - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.we(this.b,{alt:a?this.SI():""}),this.I($k));this.J(al)&&(a=a?this.text():"",$.Ze(this.D,a),this.I(al));if(this.J(bl)){if(a=fl(this)?this.CE():dl()){if(this.O=a,b=rh($.ig()))$.Ed(b,"complete",this.R1,!1,this),$.Ed(b,
...
$.F("anychart.palettes.morning","#0288d1 #58abd7 #ffe082 #f8bbd0 #f48fb1 #FA9851 #d4e157 #ff6e40 #03a9f4 #e1bee7".split(" "));$.F("anychart.palettes.coffee","#482311 #8d5932 #d8b597 #f2d1be #9b301c #d81e05 #c5e1a5 #558b2f #ffab00 #e65100".split(" "));$.F("anychart.palettes.wines","#6f3448 #857600 #f1a122 #a50b01 #400001 #a98b80 #c08081 #86614e #c26364 #615060".split(" "));$.F("anychart.palettes.turquoise","#80deea #00acc1 #00838f #29b6f6 #0277bd #0277bd #8c9eff #9575cd #ce93d8 #8e24aa".split(" "));
...
zIndex:2E3}},marker:{},bubble:{},quadrant:{scales:[{type:"linear",minimum:0,maximum:100},{type:"linear",minimum:0,maximum:100}],xScale:0,yScale:1,defaultXAxisSettings:{ticks:!1,labels:!1,title:{enabled:!1,align:"left"},stroke:"3 #FA9851"},defaultYAxisSettings:{ticks:!1,labels:!1,title:{enabled:!1,align:"left"},stroke:"3 #FA9851"},xAxes:[{},{orientation:"top"}],yAxes:[{},{orientation:"right"}],crossing:{stroke:"#FA9851"},quarters:{rightTop:{enabled:!0},leftTop:{enabled:!0},leftBottom:{enabled:!0},
